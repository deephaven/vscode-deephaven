...
A new connection will appear in the [`CONNECTIONS` panel](./panels.md#connections) on the left-hand side of VS Code when you execute the code. Additionally, the [`PANELS` tree](./panels.md) below will show any variables exposed in the connection. To disconnect, hover over the connection item and click the trash icon.
