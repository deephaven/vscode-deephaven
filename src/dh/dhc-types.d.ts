...
export namespace dh {
  ...
  export interface TotalsTable extends JoinableTable {
     ...
     */
    applyCustomColumns(
      customColumns: Array<string | CustomColumn>
    ): Array<CustomColumn>;
    /**
  ...
  export interface JoinableTable {
    ...
    join(
      ...
      columnsToMatch: Array<string>,
      columnsToAdd?: Array<string>,
      asOfMatchRule?: object
    ): Promise<Table>;
    asOfJoin(
      rightTable: JoinableTable,
      columnsToMatch: Array<string>,
      columnsToAdd?: Array<string>,
      asOfMatchRule?: string
    ): Promise<Table>;
    crossJoin(
      rightTable: JoinableTable,
      columnsToMatch: Array<string>,
  ...
  export class IdeSession implements HasEventHandling {
    ...
    getSignatureHelp(
      params: object
    ): Promise<Array<dh.lsp.SignatureInformation>>;
  ...
  export class Table implements JoinableTable, HasEventHandling {
    ...
    setViewport(
      firstRow: number,
      lastRow: number,
      columns?: Array<Column> | undefined | null,
      updateIntervalMs?: number | undefined | null
    ...
    join(
      ...
      rightTable: JoinableTable,
      columnsToMatch: Array<string>,
      columnsToAdd?: Array<string> | undefined | null,
    ...
    asOfJoin(
      ...
      columnsToMatch: Array<string>,
      columnsToAdd?: Array<string> | undefined | null,
      asOfMatchRule?: string | undefined | null
    ): Promise<Table>;
    /**
...
export namespace dh.i18n {
  ...
  export class NumberFormat {
    ...
    static format(
      ...
      number:
        | number
        | dh.BigIntegerWrapper
        | dh.BigDecimalWrapper
        | dh.LongWrapper
    ): string;
    /**
...
export namespace dh.plot {
  ...
  export interface Axis {
     ...
     */
    range(
      pixelCount?: number | undefined | null,
      min?: unknown | undefined | null,
      max?: unknown | undefined | null
    ): void;
