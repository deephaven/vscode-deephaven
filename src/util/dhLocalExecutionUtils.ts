...
/**
 * Return a sorted array of workspace folder URIs. The active workspace
 * folder (if any) will be first, followed by the rest in .
 * @returns
 */
// export function getSortedWorkspaceFolderUris(): vscode.Uri[] {
...
//   if (activeWsFolderUriStr == null) {
//     return uris;
//   }

//   return uris.sort((a, b) => {
//     if (a.toString() === activeWsFolderUriStr) {
//       return -1;
//     }
//     if (b.toString() === activeWsFolderUriStr) {
//       return 1;
//     }
//     return 0;
//   });
